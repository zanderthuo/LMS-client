        ...
        <HomeLayout>
            ...
            <div className="h-screen flex lg:px-8 px-4 pb-8 lg:pb-0  flex-col lg:flex-row justify-around items-center">
                <div className="lg:px-4 md:px-4 space-y-8 lg:w-1/2">
                    <h1 className="lg:text-5xl text-2xl text-white font-semiboldbold ">Empowering SMEs with <span className="text-yellow-500 font-bold">the Tools to Thrive</span></h1>
                    <p className="text-gray-200 lg:text-xl tracking-wider">Unlock a world of knowledge, resources, and community support tailored for small and medium-sized businesses.</p>
